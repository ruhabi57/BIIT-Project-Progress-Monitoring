...
class CGrade extends StatefulWidget {
  GetScoreCounts supervisor;
  CGrade({super.key, required this.supervisor});

  @override
  State<CGrade> createState() => _CGradeState();
}

class _CGradeState extends State<CGrade> {
  ...
  Future<void> getGradedStudents() async {
    try {
      String uri =
          '${baseUrl}Grading/GetGradedStudents?supid=${widget.supervisor.supervisorid}&grade=C';
