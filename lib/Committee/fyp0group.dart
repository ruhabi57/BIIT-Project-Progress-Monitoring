import 'package:biit_project_progress_monitoring_system/Committee/viewGroup.dart';
...
class fyp0group extends StatefulWidget {
  const fyp0group({super.key});

  @override
  State<fyp0group> createState() => _fyp0groupState();
}

class _fyp0groupState extends State<fyp0group> {
  ...
  Future<void> GetAssignProjects() async {
    try {
      String uri = '${baseUrl}Projects/GetAssignProjects?fyp_type=0';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('FYP-0 Groups')),
      body: Container(
