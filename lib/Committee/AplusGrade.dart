...
class APlusGrade extends StatefulWidget {
  GetScoreCounts supervisor;
  APlusGrade({super.key, required this.supervisor});

  @override
  State<APlusGrade> createState() => _APlusGradeState();
}

class _APlusGradeState extends State<APlusGrade> {
