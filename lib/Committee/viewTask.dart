import 'package:biit_project_progress_monitoring_system/Committee/viewUploadedTask.dart';
...
class viewTask extends StatefulWidget {
  ...
  viewTask({super.key, required this.projects});
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => viewUploadedTask(
                                  tasks: tasks[index],
                                )));
                  },
                  child: Container(
