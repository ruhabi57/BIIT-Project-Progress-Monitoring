...
class AGrade extends StatefulWidget {
  GetScoreCounts supervisor;
  AGrade({super.key, required this.supervisor});

  @override
  State<AGrade> createState() => _AGradeState();
}

class _AGradeState extends State<AGrade> {
