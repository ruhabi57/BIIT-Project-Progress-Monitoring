...
import 'reAllocateSupervisor.dart';

class groupsReAllocateSupervisor extends StatefulWidget {
  const groupsReAllocateSupervisor({super.key});

  @override
  State<groupsReAllocateSupervisor> createState() =>
      _groupsReAllocateSupervisorState();
}

class _groupsReAllocateSupervisorState
    extends State<groupsReAllocateSupervisor> {
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => (reAllocateSupervisor(
                                    project: project,
                                  ))));
                    },
                    child: Container(
