...
class BGrage extends StatefulWidget {
  GetScoreCounts supervisor;
  BGrage({super.key, required this.supervisor});

  @override
  State<BGrage> createState() => _BGrage();
}

class _BGrage extends State<BGrage> {
  ...
  Future<void> getGradedStudents() async {
    try {
      String uri =
          '${baseUrl}Grading/GetGradedStudents?supid=${widget.supervisor.supervisorid}&grade=B';
